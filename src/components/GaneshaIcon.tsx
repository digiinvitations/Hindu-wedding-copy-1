  ...
  return (
    ...
    >
      ...
      <circle
        ...
        cy="55"
        r="42"
        stroke="url(#goldGradientGanesha)"
        strokeWidth="1"
        strokeDasharray="2 2"
      ...
      <circle cx="41" cy="79" r="2.5" fill="url(#goldGradientGanesha)" />
      ...
      {/* Gradients */}
      <defs>
        <linearGradient id="goldGradientGanesha" x1="0" y1="0" x2="100" y2="120">
